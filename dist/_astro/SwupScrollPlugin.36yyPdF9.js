...
import { m as p } from "./Swup.CXlr5Q4E.js";
function a() {
  return (
    (a = Object.assign
      ? Object.assign.bind()
...
class S extends u {
    ...
    super(),
      ...
      (this.doScrollingBetweenPages = (t) => {
        ...
        const e = this.getCachedScrollPositions(t.to.url),
          n = (null == e || null == (i = e.window) ? void 0 : i.top) || 0;
  ...
  cacheScrollPositions(t) {
    const o = this.swup.resolveUrl(t),
      i = p(this.options.scrollContainers).map((t) => ({
        top: t.scrollTop,
        left: t.scrollLeft,
      })),
      s = {
  ...
  restoreScrollContainers(t) {
    ...
    o &&
      ...
      p(this.options.scrollContainers).forEach((t, i) => {
  ...
  updateScrollTarget() {
    ...
    s instanceof HTMLBodyElement && (s = null),
      i !== s &&
        ...
        null == (t = s) || t.setAttribute("data-swup-scroll-target", ""));
  }
}
export { S as default };
