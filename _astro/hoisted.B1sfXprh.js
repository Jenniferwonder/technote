import { b as is, g as as } from "./setting-utils.X5eFwt-v.js";
...
const qs = () => {
      ...
      (() => {
        ...
        return G(h, "pointerdown", (i) => {
          ...
          if (0 === E && T && x && (S || []).includes(A)) {
            ...
            if ((y.setPointerCapture(i.pointerId), t)) S(C);
            else if (!f) {
              const t = ce(tc);
              if (t) {
                const e = t(S, C, Y, (t) => {
    ...
    return [
      ...
      ({ It: t, Dt: e, Zt: r, tn: s }) => {
        const { nn: i, sn: f, en: h, cn: p } = s || {},
          ...
          [_, j] = t("scrollbars.autoHideSuspend"),
          [F] = t("scrollbars.autoHideDelay"),
          [U, N] = t("scrollbars.dragScroll"),
          [z, K] = t("scrollbars.clickScroll"),
          [V, B] = t("overflow"),
          Z = v && !e,
          J = E.x || E.y,
          Q = i || f || p || y || e,
  ...
  rc = (t) => {
    const e = Ct(),
      ...
      { vt: X, ht: q, ln: _, ot: j, bt: F } = I,
      U = [
        () => {
          xt(q, [Ht, Ue]), xt(X, Ue), p && xt(v, [Ue, Ht]);
        },
      ];
    let N = Qe([F, j, _, q, X].find((t) => t && !R(t)));
    const z = L ? X : F || j,
      K = D(yt, U);
    return [
      I,
      () => {
        ...
        return (
          ...
          o && !S && (gn(j, kt, Mo), tt(U, D(xt, j, kt))),
          sn(!S && p && e === X && t.top === t ? j : e),
          c(),
          (N = 0),
          K
        );
  ...
  lc = (t, e) => {
    const n = Ct(),
      ...
      [k, $] = mt(v),
      [M] = mt(b),
      [H] = mt({ i: (t, e) => Pe(t, e, y), o: {} }, () =>
        Ss(s) ? Lt(s, y) : {},
      ),
      [C, O] = mt({ i: (t, e) => ge(t.D, e.D) && ge(t.M, e.M), o: Ro() }),
      R = ce(Yo),
      P = (t, e) => `${e ? As : Cs}${ms(t)}`;
    return ({ It: i, Zt: l, _n: v, Dt: b }, { fn: D }) => {
      const { ft: W, Ht: I, Ct: X, dt: q, zt: _ } = l || {},
        j = R && R.tt(t, e, v, n, i),
        { it: F, ut: U, _t: N } = j || {},
        [z, K] = Js(i, n),
        [V, B] = i("overflow"),
...
const Sc = () => {
  ...
  Tc = (t) => {
    gc(t), bc(t), vc(t);
    const e = Sc();
    wc(t.body, document.body), e();
  },
  Ac = "astro:before-preparation",
  Cc = "astro:after-preparation",
  Oc = "astro:before-swap",
  kc = "astro:after-swap",
  Lc = (t) => document.dispatchEvent(new Event(t));
...
class $c extends Ko {
  ...
  loader;
  constructor(t, e, n, o, r, s, i, c, a, l) {
    super(Ac, { cancelable: !0 }, t, e, n, o, r, s, i, c),
      (this.formData = a),
...
async function Hc(t, e, n, o, r, s, i, c, a) {
  const l = new $c(t, e, n, o, r, s, window.document, i, c, a);
  return (
...
const Pc = history.pushState.bind(history),
...
const ts = (t, e, n, o, r) => {
  ...
  if (t.href !== location.href && !r)
    ...
    } else Pc({ ...n.state, index: ++oe, scrollX: 0, scrollY: 0 }, "", t.href);
  if (
    ((document.title = i),
    (_e = t),
...
customElements.define("widget-layout", Vc);
