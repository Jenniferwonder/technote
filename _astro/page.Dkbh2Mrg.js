...
async function A() {
  const [e, t, n, r, o, i, s] = await Promise.all([
      ...
      u(
        () => import("./SwupBodyClassPlugin.aa8fLSdp.js"),
        __vite__mapDeps([5, 2]),
      ).then((e) => e.default),
      u(
    ...
    a = new e({
      ...
      plugins: [
        new t(c("{}")),
        new n(c('{"preloadHoveredLinks":true,"preloadVisibleLinks":false}')),
        new r(c("{}")),
        new o(c("{}")),
        new i(c('{"awaitAssets":true}')),
        new s(c("{}")),
      ],
    });
  window.swup = a;
